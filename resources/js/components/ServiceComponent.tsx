  ...
  const services = [
    {
      ...
      description: "Creating responsive and modern websites with cutting-edge technologies for optimal user experience.",
    ...
    },
    {
      ...
      description: "Building native and cross-platform mobile applications that deliver seamless experiences across devices.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Implementing strategic marketing campaigns to increase brand visibility and drive customer acquisition.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Developing comprehensive brand identities that resonate with target audiences and drive business growth.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Implementing scalable cloud infrastructure to optimize performance and ensure business continuity.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
